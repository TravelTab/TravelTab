  ...
  return (
    <div className="main-container">
      ...
      <div className="logo-container">
        <img
          src="img/FirstPage/traveltaplogo.svg"
          alt="Travel Tap Logo"
          width="130"
          height="130"
        />
        <div className="logo-text">Travel Tap</div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="input-container">
          <div className="input-wrapper">
            ...
            />
            <img src="./img/FirstPage/Vector18_43.png" alt="이메일 아이콘" />
          </div>
          ...
          <div className="input-wrapper">
            <input
              ...
              onChange={handleChange}
            />
            <img src="./img/FirstPage/Vector23_53.png" alt="비밀번호 아이콘" />
          </div>
        </div>
        {/* 로그인 버튼 */}
        <div className="login-button-container">
          <button className="relative" id="login">
            <img
              width="182"
              height="40"
              src="./img/FirstPage/Group1618_45.png"
              alt="로그인"
            />
